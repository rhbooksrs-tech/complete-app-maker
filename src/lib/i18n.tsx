...
const EXTRA: Record<string, Record<string, string>> = {
  ...
  vencimentosProximos: {
    "pt-BR": "Vencimentos próximos",
    es: "Vencimientos próximos",
    en: "Upcoming due dates",
    de: "Bevorstehende Fälligkeiten",
    fr: "Échéances à venir",
    it: "Scadenze imminenti",
  },
  vencidas: {
    "pt-BR": "Vencidas",
    es: "Vencidas",
  ...
  janelaAlerta: {
    "pt-BR": "Avisar com antecedência de",
    es: "Avisar con antelación de",
    en: "Warn me ahead by",
    de: "Vorwarnzeit",
    fr: "Prévenir à l'avance de",
    it: "Avvisami in anticipo di",
  },
  semNotificacoes: {
    "pt-BR": "Nenhuma conta vencendo neste período. Tudo em ordem!",
    es: "Ninguna cuenta vence en este período. ¡Todo en orden!",
    en: "No bills due in this period. All good!",
    de: "Keine Rechnungen in diesem Zeitraum fällig. Alles gut!",
    fr: "Aucune facture à échéance sur cette période. Tout va bien !",
    it: "Nessuna scadenza in questo periodo. Tutto a posto!",
  },
  marcarPago: {
  ...
  previsaoPeriodoAlerta: {
    "pt-BR": "Previsão do período de alerta",
    es: "Previsión del período de alerta",
    en: "Forecast for the alert window",
    de: "Prognose für den Warnzeitraum",
    fr: "Prévision de la période d'alerte",
    it: "Previsione del periodo di avviso",
  },
};
